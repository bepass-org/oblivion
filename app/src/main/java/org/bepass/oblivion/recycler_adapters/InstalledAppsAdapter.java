package org.bepass.oblivion.recycler_adapters;
...
public class InstalledAppsAdapter extends RecyclerView.Adapter<InstalledAppsAdapter.ViewHolder> {
    ...
    public InstalledAppsAdapter(Context context, LoadListener loadListener) {
    ...
    public List<String> getSelectedApps() {
        List<String> installed = new ArrayList<>(selectedApps.size());
